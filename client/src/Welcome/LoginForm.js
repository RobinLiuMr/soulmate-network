                        ...
                        <div className="max-w-lg mx-auto text-center">
                            ...
                            <p className="mt-4 text-gray-500">
                                <q cite="https://isha.sadhguru.org/in/en/wisdom/article/are-soulmates-real-how-to-find-right-person">
                                    The body needs a mate. If it is not well
                                    developed, maybe your mind needs a mate. If
                                    your emotions have not become all-inclusive,
                                    they need a mate. At least your soul should
                                    be free from hankering!
                                </q>
                                <br />
                                &#8212;<strong> Sadhguru</strong>
                            </p>
                        </div>
                        {this.state.error && (
